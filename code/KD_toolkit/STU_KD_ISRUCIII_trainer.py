...
from STU_KD_ISRUCIII_sleepnet import STU_featurenet, STU_sleepnet
...
if __name__ == '__main__':
    ...
    for j in range(0, 1, 1):
        ...
        # pre_model_saved.save(join(path[0], 'pre_KD_BASE_student_ISRUCIII_' + str(stu_lstms) + '_' + str(j) + '.h5'))
        ...
        # seq_model_saved.save(join(path[0], f'seq_KD_BASE_student_ISRUCIII_' + str(stu_lstms) + '_' + str(j) + '.h5'))
