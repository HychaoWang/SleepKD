...
from DistillationZoo.NST import NSTLoss
...
def STU_featurenet(n_filters=128):
    ...
    myLoss = NSTLoss(1, 0, 1)([true_label, soft_label, feature_map_label, feature_map, pre_softmax])
...
def STU_sleepnet(pre_model, n_LSTM=512, context=20):
    ...
    myLoss = NSTLoss(1, 0, 1)([true_label, soft_label, feature_map_label, feature_map, seq_softmax])
