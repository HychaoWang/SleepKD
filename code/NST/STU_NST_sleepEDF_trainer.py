...
from STU_NST_sleepEDF_sleepnet import STU_featurenet, STU_sleepnet
...
if __name__ == '__main__':
    ...
    for j in range(0, 5, 1):
        ...
        pre_model.save(join(path[0], 'pre_NST_BASE_student_sleepEDF_' + str(n_lstms) + '_' + str(j) + '.h5'))
        ...
        seq_model.save(join(path[0], f'seq_NST_BASE_student_sleepEDF_' + str(n_lstms) + '_' + str(j) + '.h5'))
