...
from TA_TAKD_ISRUCIII_sleepnet import TA_featurenet, TAsleepnet
...
if __name__ == '__main__':
    ...
    for j in range(0, 5, 1):
        ...
        d.load_pretrain(i)
        seq_teacher = load_model(join(path[0], 'seq_teacher_ISRUCIII_4.h5'))
        pre_teacher = load_model(join(path[0], 'pre_teacher_ISRUCIII_4.h5'))
        pre_teacher.summary()
        seq_teacher.summary()
