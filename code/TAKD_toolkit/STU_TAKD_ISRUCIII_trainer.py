...
from STU_TAKD_ISRUCIII_sleepnet import STU_featurenet, STU_sleepnet
...
if __name__ == '__main__':
    ...
    for j in range(0, 5, 1):
        ...
        pre_model_saved.save(join(path[0], 'pre_TAKD_BASE_student_ISRUCIII_' + str(stu_lstms) + '_' + str(j) + '.h5'))
        ...
        seq_model_saved.save(join(path[0], f'seq_TAKD_BASE_student_ISRUCIII_' + str(stu_lstms) + '_' + str(j) + '.h5'))
