...
from STU_DGKD_sleepEDF_sleepnet import STU_featurenet, STU_sleepnet
...
if __name__ == '__main__':
    ...
    for j in range(5, 10, 1):
        ...
        pre_TA = keras.models.load_model(join(path[0], f'pre_logitLoss_TA_sleepEDF_256_4.h5'))
        seq_TA = keras.models.load_model(join(path[0], f'seq_logitLoss_TA_sleepEDF_256_4.h5'))
        seq_teacher.summary()
        pre_teacher.summary()
        ...
        pre_model_saved.save(os.path.join("../weights/Baseline", 'pre_DGKD_BASE_student_sleepEDF_' + str(stu_lstms) + '_' + str(j) + '.h5'))
        ...
        seq_model_saved.save(os.path.join("../weights/Baseline/models", f'seq_DGKD_BASE_student_sleepEDF_' + str(stu_lstms) + '_' + str(j) + '.h5'))
