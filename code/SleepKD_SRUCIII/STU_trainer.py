...
if __name__ == '__main__':
    ...
    for j in range(5, 10, 1):
        ...
        d.load_pretrain(i)
        pre_teacher = keras.models.load_model(join(path[0], f"pre_NOHARD_TA_ISRUCIII_256_4.h5"))
        seq_teacher = keras.models.load_model(join(path[0], f"seq_NOHARD_TA_ISRUCIII_256_4.h5"))
        ...
        pretrain_acc_record.append(get_student_pre_acc(pre_model.predict(pre_test_data), d.y_test))
        ...
        # pre_model_saved.save(join(path[0], 'pre_T_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # pre_model_saved.save(join(path[0], 'pre_epochLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # pre_model_saved.save(join(path[0], 'pre_seqLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # pre_model_saved.save(join(path[0], 'pre_logitLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # pre_model_saved.save(join(path[0], 'pre_hardLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # pre_model_saved.save(join(path[0], 'pre_T_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        pre_model_saved.save(join(path[0], 'pre_NOHARD_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        ...
        finetune_acc_record.append(tmp_Seq_acc)
        ...
        # seq_model_saved.save(join(path[0], f'seq_T_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # seq_model_saved.save(join(path[0], f'seq_epochLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # seq_model_saved.save(join(path[0], f'seq_seqLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # seq_model_saved.save(join(path[0], f'seq_logitLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # seq_model_saved.save(join(path[0], f'seq_hardLoss_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        # seq_model_saved.save(join(path[0], f'seq_T_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        seq_model_saved.save(join(path[0], f'seq_NOHARD_student_ISRUCIII_' + str(n_lstms) + '_' + str(j) + '.h5'))
        print()
    avg_acc = sum(finetune_acc_record) / len(finetune_acc_record)
    print(pretrain_acc_record)
    print(finetune_acc_record)
